...
//import com.mysql.cj.xdevapi.Statement; パッケージはjava.sqlが正しい
...
public class DbConnectSample02 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //2.DBと接続する
            con=DriverManager.getConnection("jdbc:mysql://localhost/world?useSSL=false&allowPublicKeyRetrieval=true","root","LivieAshSwiftie1387");
